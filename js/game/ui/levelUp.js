var LevelUp = function() {
    ...
    return r.show = function() {
        e.rank.skin = "ui/b_icon_rank" + User.rank1 + ".png", e.rankbefore.skin = "ui/b_icon_rank" + (User.rank1 - 1) + ".png", e.msg.text = "Wow!I got the " + o[User.rank1 + 1] + " rank. Can you surpass me?", e.visible = !0, Laya.Tween.from(e.body, {
                scaleX: 0,
                scaleY: 0
            }, 300),
            function() {
                function a() {
                    ...
                    for (var r = 3 + Math.floor(3 * Math.random()), o = 0; o < r; o++) {
                        ...
                        t.skin = "effects/lizi" + Math.floor(1 + 4 * Math.random()) + ".png", t.x = 100 + 500 * Math.random(), t.y = 200 + 100 * Math.random(), t.speedY = 1, t.scaleX = .6 * Math.random(), t.scaleY = t.scaleX, t.rotation = 360 * Math.random(), t.speedX = 5 * Math.random() * (t.x - 320) > 0 ? 1 : -1, e.addChild(t),
                            function(a) {
                                var e = 180 * Math.random();
                                Laya.timer.frameLoop(1, null, function n() {
                                    e -= 1, a.x += 1 * a.speedX, Math.abs(a.speedX) > .05 ? a.speedX -= .05 * a.speedX / Math.abs(a.speedX) : a.speedX = 0, a.y += t.speedY, a.speedY += .2, e <= 0 && (a.destroy(), Laya.timer.clear(null, n))
                                })
                            }(t)
                    }
        ...
        }), Laya.stage.addChild(e), e.visible = !1, e.btn.on("click", null, r.hide);
